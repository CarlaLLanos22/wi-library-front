            ...
            <div className="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
              ...
              {proveedores.map(({ id_proveedor, nombre, direccion, telefono, mail})=>(
                                    <tr key={id_proveedor}>
                                        ...
                                        <th className="px-6 py-3 border-b border-gray-200  text-left text-xs leading-4 font-medium text-gray-600 uppercase tracking-wider">
                                            <span className="cursor-pointer" onClick={()=>{eliminarProveedor(id_proveedor)}}>🗑️</span>
                                            <span className="cursor-pointer" onClick={()=>{clickProveedor({ id_proveedor, nombre, direccion, telefono, mail })}}>📝</span>
                                        </th>
                                    </tr>
